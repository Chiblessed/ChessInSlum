      ...
      <div>
        <div className="overflow-hidden py-10 px-0  whitespace-nowrap feturewrap">
          <div className=" flex sm:max-w-72">
            <img src={CNN} alt="" className="w-20 featureitem featureitem1" />
            <img src={BBC} alt="" className="w-20 featureitem featureitem2" />
            <img
              src={Newyorktimes}
              alt=""
            ...
            />
            <img src={Punch} alt="" className="w-20 featureitem featureitem5" />
            <img
              src={Reuters}
              alt=""
            ...
            />
            <img src={CNN} alt="" className="w-20 featureitem featureitem8" />
          </div>
        </div>
      </div>
    </div>
